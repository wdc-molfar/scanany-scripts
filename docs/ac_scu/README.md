...
Програмний модуль має позначення **"ac_scu"**.
...
Програмний модуль **"ac_scu"** призначений для завантаження текстів веб-документів – текстів анотацій, розміщених на веб-сайтаі [academia.edu](https://www.academia.edu/), які містять ключові слова (теги) із заданого переліку, а також перетворення завантаженої інформації до внутрішнього системного вигляду. 
