...
Програмний модуль має позначення **"ig_scu_pi"**.
...
Програмний модуль **"ig_scu_pi"** призначений для завантаження повних текстів веб-документів, що опубліковані вибраними користувачами мережі `Instagram`, що розміщаються на веб-сайті [picuki.com](https://www.picuki.com/), а також перетворення завантаженої інформації до внутрішнього системного вигляду. 
...
Програмний модуль **"ig_scu_pi"** завантажує масиви даних, що відповідають заданому набору аккаунтів користувачів і розміщуються на веб-сайтах [Instagram](https://www.instagram.com/) і [picuki.com](https://www.picuki.com/), виокремлює контент з цих  масивів, забирає посилання, якщо посилання ще не використовувалось раніше, продовжує обробку даних повідомлення, перетворює ці дані до внутрішнього системного формату, викликає програмний модуль перетворення даних із внутрішнього системного формату до формату `XML`.
